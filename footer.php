  ...
  <div class="container">
    <div class="row">
      ...
      <div class="imgfoot col-xs-12 col-sm-4">
        ...
        <p style="text-align:center; ">&copy; 2019 Gobierno del Estado de Hidalgo<p>
      </div>
      <div class="col-sm-4 redes" >
        <p style="text-align:center;margin-top: 80px;"><strong style="font-size: 20px;">Contacto</strong><br>Carretera México - Pachuca, Centro Minero Col. Venta Prieta<br>Pachuca de Soto, Hidalgo, México<br>+52 (771) 71 76000</p>
        <div>
          <center>
